...
class LinkedList {
    ...
    private class Node {
         ...
         * @param      tnext  The next
         */
        Node(final int tdata, final Node tnext) {
            this.data = tdata;
            this.next = tnext;
        }
    }
    ...
    /**
     * function to help insertat function. it inserts the element in recursevely
     *
     * @param      thead  The head
     * @param      cnt    The count
     * @param      ele    The ele
     *
     * @return     { description_of_the_return_value }
     */
    public Node insertHelper(
        final Node thead, final int cnt, final int ele) {
        if (cnt == 0) {
